...
Необхідно вказати платформу OXID, SHOPWARE, MAGENTO2, ESPO, TREOPIM, TREOCORE, TREODAM.

>PLATTFORM=TREOPIM

>Заченння за умовчанням _TREOPIM_

>Допустимі значення OXID, SHOPWARE, MAGENTO2, ESPO, TREOPIM, TREOCORE, TREODAM
